(()=>{
  ...
  function buildDesktop(nav){
    ...
    menu.forEach(group=>{
      ...
      const a=document.createElement('a');a.href=group.href;a.textContent=group.label;
      if([group.href,...group.items.map(x=>x[1])].some(active))a.classList.add('active');
      const dd=document.createElement('div');dd.className='dropdown';
      group.items.forEach(([label,href])=>{const x=document.createElement('a');x.href=href;x.textContent=label;if(active(href))x.classList.add('active');dd.appendChild(x)});
  ...
  function injectStyles(){
    ...
    s.textContent=`
      ...
      .unified-footer .footer-brand small{display:block;letter-spacing:.14em;font-weight:800;font-size:13px;margin-bottom:4px}.unified-footer .footer-brand strong{display:block;font-size:31px;line-height:1.05;color:#eaf2ee}.unified-footer .footer-brand p{margin:34px 0 0;line-height:1.8;color:#aebdb6;font-size:15px}
      .unified-footer .footer-info{display:grid;gap:18px}.unified-footer .footer-info p{margin:0;color:#aebdb6;font-size:15px;line-height:1.55}.unified-footer .footer-info b{display:inline-block;min-width:58px;color:#edf4f0}.unified-footer .footer-info a{color:#edf4f0;font-weight:800;text-decoration:none}.unified-footer .footer-info a:hover{text-decoration:underline}
      .unified-footer .footer-links{display:grid;gap:17px}.unified-footer .footer-links a{color:#e4ece8;font-weight:800;font-size:16px}.unified-footer .footer-links a:hover{opacity:.78}
  ...
  function injectBottomNav(){
    ...
    const morePaths=['/menu.html','/about.html','/staff.html','/worship.html','/transport.html','/visit.html','/sarangbang.html','/men-mission.html','/women-mission.html','/choir.html','/sunday-school.html','/young-adults.html','/mission-support.html','/app-download.html'];
  ...
  function loadCommonSeo(){if(document.querySelector('script[data-site-seo]'))return;const s=document.createElement('script');s.dataset.siteSeo='1';s.src='/js/seo-meta.js?v=seo2';document.head.appendChild(s)}
  function loadChannelPopup(){if(!isHome||document.querySelector('script[data-channel-popup]'))return;const s=document.createElement('script');s.dataset.channelPopup='1';s.src='/js/channel-popup.js?v=channelpopup3';document.head.appendChild(s)}
