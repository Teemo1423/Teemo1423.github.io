  ...
  function applyGlobalTone(){
    ...
    style.textContent=`
      ...
      @media(min-width:901px){
        ...
        .site-header .navlinks.staggered-nav{display:flex!important;flex-direction:column!important;justify-content:center!important;align-items:stretch!important;gap:clamp(3px,.4vw,7px)!important;align-self:center!important;height:auto!important;min-height:0!important;flex:1!important;max-width:1080px!important;margin-inline:auto!important;font-size:clamp(15px,1.15vw,17px)!important;white-space:nowrap!important}
        .site-header .staggered-nav .nav-row{display:flex!important;align-items:center!important;justify-content:space-between!important;flex-wrap:nowrap!important;gap:clamp(18px,1.8vw,32px)!important;min-height:0!important;height:auto!important;line-height:1.25!important;white-space:nowrap!important;width:100%!important;max-width:none!important}
        .site-header .staggered-nav .nav-row-top{padding-left:0!important;padding-right:clamp(12px,1.4vw,24px)!important;transform:none!important}
        .site-header .staggered-nav .nav-row-bottom{padding-left:clamp(34px,3.4vw,62px)!important;padding-right:clamp(42px,4vw,72px)!important;transform:none!important}
      ...
      @media(min-width:901px) and (max-width:1180px){.site-header .nav{gap:12px!important;padding-top:8px!important;padding-bottom:8px!important}.site-header .navlinks.staggered-nav{font-size:14px!important;gap:2px!important;max-width:900px!important}.site-header .staggered-nav .nav-row{gap:12px!important}.site-header .staggered-nav .nav-row-top{padding-right:8px!important}.site-header .staggered-nav .nav-row-bottom{padding-left:22px!important;padding-right:28px!important}}
