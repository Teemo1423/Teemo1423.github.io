(()=>{
  ...
  function applyGlobalTone(){
    ...
    style.textContent=`
      ...
      @media(min-width:901px){.site-header .navlinks{gap:clamp(9px,1.05vw,17px)!important;font-size:clamp(16px,1.15vw,18px)!important;white-space:nowrap!important;flex-wrap:nowrap!important}.site-header .navlinks>a,.site-header .navitem>a{white-space:nowrap!important;word-break:keep-all!important;font-weight:800!important;letter-spacing:-.035em}}
      @media(min-width:901px) and (max-width:1180px){.site-header .navlinks{gap:7px!important;font-size:15px!important}.site-header .nav{gap:12px!important}}
